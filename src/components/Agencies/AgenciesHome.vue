      ...
      <div class="carousel">
        <el-carousel height="365px">
          <el-carousel-item v-for="item,index in 4" :key="index">
            <a href="javascript:;">
              <img src="../../assets/img/homePageImage.jpg" alt="" width="493" height="182">
            </a>
            <a href="javascript:;">
              <img src="../../assets/img/homePageImage.jpg" alt="" width="246" height="182">
            </a>
            <a href="javascript:;">
              <img src="../../assets/img/homePageImage.jpg" alt="" width="246" height="182">
            </a>
            ...
            <a href="javascript:;">
              <img src="../../assets/img/homePageImage.jpg" alt="" width="247" height="366">
            </a>
